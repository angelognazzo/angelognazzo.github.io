...
I am a PhD student in Machine Learning at TU Wien and [AITHYRA](https://aithyra.at/){:target="_blank"}, advised by [İsmail İlkan Ceylan](https://www.cs.ox.ac.uk/people/ismaililkan.ceylan/){:target="_blank"} and [Michael Bronstein](https://www.cs.ox.ac.uk/people/michael.bronstein/){:target="_blank"}. 

My research focuses on the development of fundamental methodology on generative models, with a particular interest in **discrete generative models** (language, graphs and other discrete structures) and also the understaing of their statistical guarantees and of their capacity for **memorization, generalization, and reasoning**. 
...
*   **September, 2025**: I have attented the ["Random Matrix Theory for Learning and Statistical Physics" Workshop](https://www.uni-bielefeld.de/einrichtungen/zif/events/#/event/8068){:target="_blank"}. 
...
*   **August, 2023**: I have attented the [Mediterranean Machine Learning Summer School](https://www.m2lschool.org/past-editions/m2l-2023-greece){:target="_blank"} 2023 edition, which took place in Thessaloniki.
...
We studied the problem of estimating covariance matrices. In particular, the main question we posed ourselves is: "Which is the minimal sample size n to guarantee that the sample covariance matrix approximates with epsilon accuracy the true covariance matrix?" Take a look at it [here](https://angelognazzo.github.io/files/ETH_Z%C3%BCrich_Angelo_Gnazzo_Thesis_Covariance_Estimation.pdf){:target="_blank"}!
*   **June, 2022**: I started working at @ ETH AI Center as a research intern, advised by [Amartya Sanyal](https://amartya18x.github.io/){:target="_blank"}. I am going to be focusing on problems at the intersection of Differential Privacy and Online Learning!
*   **June, 2022**: I finished my semester research project at ETH. I worked under the supervision of [Nikita Zhivotovskiy](https://sites.google.com/view/nikitazhivotovskiy/){:target="_blank"} and [Afonso Bandeira](https://people.math.ethz.ch/~abandeira/){:target="_blank"} on a survey paper, titled “Generalization Error Bound via Information-Theoretic Methods and Convex Analysis”. Take a look at it [here](https://angelognazzo.github.io/files/Semester_Paper__Generalization_Error_Bounds.pdf){:target="_blank"}.
*   **March, 2022**: I published my first blog post on Medium about the “Method of Interlacing Polynomials”, introduced by Adam Marcus, Daniel Spielman, Nikhil Srivastava. Take a look at it [here](https://medium.com/@gnazzoangelo/an-introduction-to-the-method-of-interlacing-polynomials-87798aec38ff){:target="_blank"}. Hopefully, I will be posting more blog posts in the next few months.
